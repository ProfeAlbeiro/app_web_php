            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="?c=Landing&a=register">Regístrate</a>
                        </li>
                    </ul>
                </div>
            ...
            <form class="col-md-9 m-auto" action="?c=Users&a=user_create" method="post">
                <div class="row">                    
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control mt-1" id="name" name="rol" placeholder="Rol">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputemail">Apellido</label>
                        <input type="text" class="form-control mt-1" id="email" name="apellido" placeholder="Apellido">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control mt-1" id="email" name="fecha" placeholder="Fecha">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputname">Género</label>
                        <input type="text" class="form-control mt-1" id="name" name="genero" placeholder="Género">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputemail">Estado M</label>
                        <input type="text" class="form-control mt-1" id="email" name="estado_m" placeholder="Estado Marital">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputname">Edad</label>
                        <input type="text" class="form-control mt-1" id="name" name="edad" placeholder="Edad">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputemail">Dirección</label>
                        <input type="text" class="form-control mt-1" id="email" name="direccion" placeholder="Dirección">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputname">Teléfono</label>
                        <input type="text" class="form-control mt-1" id="name" name="telefono" placeholder="Teléfono">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputemail">Celular</label>
                        <input type="text" class="form-control mt-1" id="email" name="celular" placeholder="Celular">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputname">Email</label>
                        <input type="email" class="form-control mt-1" id="name" name="mail" placeholder="Email">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputname">Profesión</label>
                        <input type="text" class="form-control mt-1" id="name" name="profesion" placeholder="Profesión">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputemail">Contraseña</label>
                        <input type="password" class="form-control mt-1" id="email" name="pass" placeholder="Contraseña">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputemail">Estado</label>
                        <input type="number" class="form-control mt-1" id="email" name="estado" placeholder="Estado">
                    </div>
                </div>                         
                <div class="row">
